    ...
    public class AuthService : IAuthService
    {
       ...
       public AuthService(UserManager<ApplicationUser> userManager ,RoleManager<IdentityRole>roleManager, IOptions<JWT> jwt)
        ...
        public async Task<AuthModel> RegisterAsync(RegisterModel model)
        {
            ...
            // Initialize refresh tokens collection if null and add new token
        ...
        public  async Task<AuthModel> RefreshTokenAsync(string token)
        {
            ...
            // Clear existing refresh tokens and add new one
        ...
        public async Task<string> RefreshJwtAsync(string refreshToken)
        {
            ...
            var activeRefreshToken = user.RefreshTokens.SingleOrDefault(t => t.Token == refreshToken);
