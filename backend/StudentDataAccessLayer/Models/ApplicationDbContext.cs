...
namespace StudentDataAccessLayer.Models
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configure RefreshToken as owned entity
            modelBuilder.Entity<ApplicationUser>(b =>
            {
                b.OwnsMany(u => u.RefreshTokens, rb =>
                {
                    rb.WithOwner().HasForeignKey("ApplicationUserId");
                    rb.HasKey("Id", "ApplicationUserId");
                    rb.Property<int>("Id").ValueGeneratedOnAdd();
                });
            });
            
            // Configure Student entity to match database schema
            modelBuilder.Entity<Student>(b =>
            {
                b.Property(s => s.Status)
                    .HasColumnType("bit") // Matches database bit type
                    .HasDefaultValue(true); // true = Active
                
                b.Property(s => s.CreatedAt)
                    .HasColumnType("datetime") // Matches database datetime type
